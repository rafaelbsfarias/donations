...
function asaas_enqueue_scripts() {
    ...
    wp_register_script('asaas-form-recaptcha', $plugin_url . 'assets/frontend/js/form-recaptcha.js', ['jquery'], '1.0.0', true);
    wp_register_script('asaas-form-script', $plugin_url . 'assets/frontend/js/form-script.js', ['jquery', 'asaas-form-utils', 'asaas-form-masks', 'asaas-form-ui', 'asaas-form-ajax', 'asaas-form-recaptcha'], '1.0.0', true);
    ...
    // Carregar script do reCAPTCHA se chave estiver configurada
    ...
    // Localizar reCAPTCHA com nome correto
